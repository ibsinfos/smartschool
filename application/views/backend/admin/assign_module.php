<script type="text/javascript">
  $(function(){
   ...
   function get_module(group_id) {
    	...
    	$.ajax({
            url: '<?php echo base_url();?>index.php?admin/get_module/' + group_id ,
		...
		<div class="tab-content">            
			...
			<div class="tab-pane box active" id="add" style="padding: 5px">
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/assign_module/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                        	<div class="form-group mandatory"><div class="col-sm-5"> * Fields are mandatory </div></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Group Name');?><span class="mandatory">*</span></label>
                                <div class="col-sm-3">
                                    <select name="group_name" class="form-control" style="width:100%;" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" onchange="return get_module(this.value);">
                  ...
                  <div class="form-group">          
          		 <label class="col-sm-3 control-label">Modules<span class="mandatory">*</span></label>
				<div class="col-sm-3">
				...
				<div class="col-sm-3">
					<select name="module_name[]" id="multiselect_to" class="form-control" size="8" multiple="multiple" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"></select>
				</div>
				</div>	
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-3">
                                  <button type="submit" class="btn btn-info">Assign Module</button>
                              </div>
						   </div>
                    </form>                
                </div>                
