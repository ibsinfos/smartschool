                ...
                <div id="main_attendance" class="col-md-12"> 
                          ...
                          <?php }  ?> 			
                           ...
                           <div class="form-group">
                                <div class="row">
	                                <div class="col-sm-4">
	                                <input type="text" name="from_date" placeholder="From Date" id="from_dates" class="form-control datepicker" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" />
	                                </div>
                                </div>                           	
                                <!-- <label class="col-sm-3 control-label">From Date</label> -->
                            </div>
            ...
            <div class="tab-pane box active" id="list" style="width:100%;">
                 ...
                 <table class="table datatable table" border="0" cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:14px; letter-spacing:0.5;" id="table_export">
                    ...
                    <tbody>
						...
						$this->db->where('attendance.attandence_class', intval($class_id));
						$this->db->where('attendance.date BETWEEN "'. date('Y-m-d', strtotime($from_date)). '" and "'. date('Y-m-d', strtotime($to_date)).'"');
