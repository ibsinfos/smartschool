	...
	<div class="col-md-12"> 
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list" style="width:100%;">
                <table class="table datatable table" border="0" cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:14px; line-height:25px; letter-spacing:0.5;" id="table_export">
                	<thead>
                    <tr>
                            <td colspan="4">
                                <table width="100%">
                        ...
                        <tr bgcolor="#000000"><td colspan="4" style="font-size:1.2em; text-align:center; font-weight:600; padding:6px 0px; color:#FFF;">Exam Time Table </td></tr>
                          <tr bgcolor="#000000"><td colspan="4" style="font-size:1.1em; text-align:center; font-weight:600; padding:6px 2px; color:#FFF;">  <?php
