                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable" id="table_export">
                	<thead>
                		<tr>
                    		...
                    		<th width="110"><div>Time Stamp</div></th>
                    		<th><div>Action</div></th>
						</tr>
					</thead>
                    <tbody>
                    	<?php $count = 1;foreach($notification as $row):?>
						<tr>
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/notification/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>                           
                            <div class="form-group">
                                <label class="col-sm-1 control-label">Notification</label>
                                <div class="col-sm-5">
                                    <div class="box closable-chat-box">
                                        <div class="box-content padded">
                                                <div class="chat-message-box">
                                                <textarea name="notice" id="ttt" rows="5" placeholder="Write Notification" class="form-control" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"></textarea>
                                                </div>
                                        </div>
                                    </div>
                                </div>
