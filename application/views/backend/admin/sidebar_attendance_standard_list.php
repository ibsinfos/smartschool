                 ...
                 <table class="table datatable table" border="0" cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:14px; letter-spacing:0.5;" id="table_export">
                	<thead>
                        ...
                        <tr bgcolor="#000000"><td colspan="11" style="font-size:1.2em; text-align:center; font-weight:600; padding:6px 0px; color:#FFF;">Student Absent Listing</td></tr>
                          <tr bgcolor="#000000">
                            <td colspan="6" style="font-size:1.2em; text-align:center; font-weight:600; padding:6px 0px; color:#FFF;">   <?php echo ucwords('Standard : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.$class_id.'</span> Date : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.date("F d, Y",strtotime($from_date)).' To '.date("F d, Y",strtotime($to_date)).'</span>'); ?>
                		</td></tr>
                		
                        <tr bgcolor="#2092D0">
                    		<th style="color:#FFF; padding:6px 6px;border-right:1px solid #EEE; text-align:center;">Roll no</th>
                            <th style="color:#FFF; padding:6px 6px;border-right:1px solid #EEE; text-align:center;">Class Name</th>
                    		<th style="color:#FFF; padding:6px 6px;border-right:1px solid #EEE; text-align:center;">Student Name</th>
                    		<th style="color:#FFF; padding:6px 6px; border-right:1px solid #EEE; text-align:center;">Absent Date</th>  
					...
					/*	echo "<pre>";
						...
						?>
                        <tr>
                            <td valign="middle" align="center"  style="font-size:13px; padding:6px 6px; border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;" ><?php echo $row_attendance['roll'];?></td>							
                            
                        	<td valign="middle" align="center" style="font-size:13px; padding:6px 6px; border-bottom:1px solid #EEE; border-left:0px solid #EEE; border-right:0px solid #EEE;" ><?php echo $row_attendance['attandence_class'];?></td>
							<td valign="middle" align="center" style="font-size:13px; padding:6px 6px; border-bottom:1px solid #EEE; border-left:0px solid #EEE; border-right:0px solid #EEE;" ><?php echo $row_attendance['name'].' '.$row_attendance['father_name'];?></td>
							<td valign="middle" align="center" style="font-size:13px; line-height:18px; padding:6px 6px; border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;" ><?php echo date("F d, Y",strtotime($row_attendance['date']));?></td>							
