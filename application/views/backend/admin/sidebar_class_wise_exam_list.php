...
<div id="main_exam_mark">
  <div id="exam_mark_sub_1" style="display:none;">
    ...
    <form action="<?php echo base_url() . 'index.php?admin/exam_mark/class_wise_exam'; ?>" method="post" id="class_wise_exam"  class="form-horizontal validate">
      <div class="form-group">
                ...
                <table class="table datatable table" border="0" cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:14px; letter-spacing:0.5;" id="table_export">
                	<thead>
                        ...
                        <tr bgcolor="#000000"><td colspan="4" style="font-size:1.2em; text-align:center; font-weight:600; padding:6px 0px; color:#FFF;">Exam Time Table</td></tr>
                         <tr bgcolor="#000000"><td colspan="4" style="font-size:1.2em; text-align:center; font-weight:600; padding:6px 0px; color:#FFF;">Class Name : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;"><?php echo $class_id; ?></span> Exam : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;"><?php echo $exam_title->name; ?></span></td></tr>
