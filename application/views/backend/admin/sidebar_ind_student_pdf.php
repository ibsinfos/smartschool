...
$date1=date_create("2015-09-01");
 ...
 $present_count=($total_count)-($attendance);
        ...
        $num_of_percent =  number_format($t, 1, '.', '');
                        ...
                        <tr><td><b style="font-weight:900;">Name</b></td><td><?php echo $row['name']; ?></td>
                        <td style="margin-top:10px;" rowspan="3">
                        ...
                        <tr><td><b style="font-weight:900;">Recent Assessment</b></td><td><?php if(!empty($behaviour[0]['behaviour'])){ echo wordwrap($behaviour[0]['behaviour'],100,"<br>\n"); } ?></td></tr>
