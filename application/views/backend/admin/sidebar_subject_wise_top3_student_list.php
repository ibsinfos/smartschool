		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list" style="width:100%;">
				...
				echo ucwords("Standard : <span style='text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;'>".$standard."</span>"); ?>
                        ...
                        <tr bgcolor="#2092D0">
                        <th class="sorting_asc" aria-sort="ascending" style="color:#FFF; padding:6px 0px; border-right:1px solid #EEE;  text-align:center;" width="20%">Subject Name</th>
                    		<th class="sorting" aria-sort="descending" style="color:#FFF; padding:6px 0px; border-right:1px solid #EEE;  text-align:center;" width="20%">Student Name</th>
                      <th style="color:#FFF; padding:6px 0px; border-right:1px solid #EEE;  text-align:center;" width="20%">Class Name</th>
                                	
                    		<th style="color:#FFF; padding:6px 0px; border-right:1px solid #EEE;  text-align:center; " width="40%">Marks</th>
