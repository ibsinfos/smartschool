...
.modal-dialog{   width:50%; }
                ...
                <div id="main_timetable"> 
                          ...
                          <form action="" method="post" id="class_wise_timetable" class="form-horizontal validate">
                          	<div class="form-group">
                          ...
                          <div id="timetable_sub_2" style="display:none;">
                           ...
                           <form action="" method="post" id="teacher_wise_timetable" class="form-horizontal validate" >
                          <div class="form-group">
                                ...
                                <label class="col-sm-1 control-label">Month</label>
                                <div class="col-sm-3">
                                 <select name="month" id="montht" data-validate="required"  onchange="return weekCount2(this.value);"  data-message-required="<?php echo get_phrase('value_required');?>"   class="form-control">
                                 <option value="">Select Month</option>
                        		 <option value="1">January </option>
                                 <option value="2">February </option>
                                 <option value="3">March</option>
