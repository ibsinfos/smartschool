<div class="row">
	<div class="col-md-12">
		...
		<div class="tab-content">            
			...
			<!--TABLE LISTING ENDS-->
            <?php echo form_open(base_url() . 'index.php?admin/update_group/do_update' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                        	<div class="form-group mandatory"><div class="col-sm-5"> * Fields are mandatory </div></div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('Select Group');?><span class="mandatory">*</span></label>
                                <div class="col-sm-3">
