	...
	$(document).ready(function(){
		$('#btnadd').click(function(){	
			...
			else
			{
				$.ajax({			
					type: "post",			
					url: "<?php echo base_url('/index.php?teacher/get_receiver');?>",			
					data: {
						ids:queryArr,
						type:$("#txtentity").val(),				
					},
...
<div class="panel-body">	
	<?php
		...
		elseif($_POST['entity']==2)
		{
			...
			{
			?>
			<select class="form-control" name="drpclass"  id="drpclass" required>
...
<script>
	$("#drpclass").change(function () {
		...
		$.ajax({   
			...
			url: "index.php?getinfo/getinfostudent", //The url where the server req would we made.
...
<script>
	$("#drpclassparent").change(function () {
		...
		$.ajax({   
			...
			url: "index.php?getinfo/getinfoparent", //The url where the server req would we made.
