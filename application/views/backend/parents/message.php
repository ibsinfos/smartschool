		...
		<table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable" id="table_export">
			...
			<tbody>
				...
				<?php $count = 0;
					...
					$current_user = 'parent-' . $this->session->userdata('login_user_id');
...
function addId(id ,name ,message,type,typeid){
		...
		$.ajax({
			...
			url: "<?php echo base_url('/index.php?parents/message/message_read1');?>/"+id,
	...
	$("#dropdownMenu2").change(function () {
		...
		else
		{
			...
			$.ajax({   
				...
				url: "index.php?getinfo/fromparent", //The url where the server req would we made.
