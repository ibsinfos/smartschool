                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                   ...
                                   <?php 
								    ...
								    $exam_query = $this->db->get_where('exam',array('class_id'=>intval($this->session->userdata('class_name'))))->result_array();
...
$("#exam_result_form").submit(function( event ) {
  ...
  if(exam_name != ""){
		$.ajax({
				url: '<?php echo base_url();?>index.php?student/get_exam_data_table/',
