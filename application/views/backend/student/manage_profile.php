<div class="row">
	<div class="col-md-12">
		...
		<div class="tab-content">
                    ...
                    foreach($edit_data as $row):
                        ...
                        <?php echo form_open(base_url() . 'index.php?student/manage_profile/update_profile_info' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top' , 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" readonly class="form-control" name="name" value="<?php echo $row['name'];?>"/>
                                </div>
                            </div>
           ...
           <input type="hidden" name="txtoldphoto" value="<?=$row['student_image']?>">
                                            <img src="<?=base_url();?>uploads/student_image/<?=$row['student_image']?>" alt="...">
                                        </div>
