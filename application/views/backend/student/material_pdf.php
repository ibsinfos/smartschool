            ...
            <div class="tab-pane box active" id="list" style="width:100%;">
                ...
                <table class="table datatable table" border="0" cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:14px; letter-spacing:0.5;" id="table_export">
                    ...
                    <tbody>
						...
						$array = array("student.student_id"=>$std_id);
						$this->db->select('*');
						$this->db->from('share_material');
						$this->db->join('student', 'student.class_id = share_material.class_id');
						//$this->db->join('subject', 'subject.class_id = share_material.class_id');
						$this->db->where($array);
						$query = $this->db->get();
						$share_material =$query->result();	
						$count = 1;
