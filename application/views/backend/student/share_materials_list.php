		...
		<div class="tab-content">
            ...
            <div class="tab-pane box active" id="list" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align="center" style="font-size:12px;  border-bottom:1px solid #EEE; border-left:0px solid #EEE; border-right:0px solid #EEE;" width="25%">
								<?php  $sub_name		=	$this->db->get_where('subject' , array('subject_id' => $sm_row['subject_id']) )->result_array(); 
				...
				if(count($share_material) > 0){
				 echo form_open(base_url() . 'index.php?student/share_materials_pdf' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
