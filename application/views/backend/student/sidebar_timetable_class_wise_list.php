            ...
            <div class="tab-pane box active" id="list" style="width:100%;">
				...
				<table class="table datatable table" border="0" cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:14px; letter-spacing:0.5;" id="table_export">
                	<thead>
                        ...
                        <tr bgcolor="#000000"><td colspan="11" style="font-size:1.2em; text-align:center; font-weight:600; padding:6px 0px; color:#FFF;">Time Table</td></tr>
                		<tr bgcolor="#000000"><td colspan="7" style="font-size:1.0em; text-align:center; font-weight:600;  color:#FFF;  padding:6px 0px;"> <?php  echo ucwords('Month : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.date('F', mktime(0, 0, 0, $month, 10)).'</span>');echo '&nbsp;&nbsp;&nbsp;&nbsp;'.ucwords('Week : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.$week.'</span>'); ?></td></tr>
                        <tr bgcolor="#2092D0">
                    		<th style="color:#FFF; padding:6px 6px; width:10%; border-right:1px solid #EEE; text-align:center;" width="20%">Date</th>
                    		<th style="color:#FFF; padding:6px 6px;  width:10%;  border-right:1px solid #EEE; text-align:center;" width="15%">Day</th>
                    		<th style="color:#FFF; padding:6px 6px;  width:10%;border-right:1px solid #EEE; text-align:center;" width="20%">Subject</th>  
                            <th style="color:#FFF; padding:6px 6px;  width:10%; border-right:1px solid #EEE; text-align:center;" width="20%">Teacher</th> 
                            <th style="color:#FFF; padding:6px 6px;  width:10%; border-right:1px solid #EEE; text-align:center;" width="25%">Time</th>   
						</tr>
					</thead>
                    <tbody>
                    	<?php 
                        ...
                        <tr>
							...
							<td valign="middle" align="center" style="font-size:13px;  border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;" ><?php echo $row_timetable['day'];?></td>
							<td valign="middle" align="center" style="font-size:13px;  border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;" ><?php echo $row_timetable['subject_name'];?></td>			
                            <td valign="middle" align="center" style="font-size:13px;  border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;" ><?php echo $row_timetable['teacher_name'];?></td>			
                            <td valign="middle" align="center" style="font-size:13px;  border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;" ><?php echo $row_timetable['time_start'].'  TO  '.$row_timetable['time_end'];?></td>							
						</tr>
                        <?php endforeach;?>
				...
				<?php if($timetable > 0){ ?>
					<?php echo form_open(base_url() . 'index.php?student/timetable_pdf/class_wise_timetable' , array('class' => 'form-horizontal validate'));?>	
					<div class="form-group">
