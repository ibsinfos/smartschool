                   ...
                   <tr>
                        ...
                        <tr><td colspan="5" style="height:15px;"></td></tr>
                         <tr bgcolor="#000000"><td colspan="5" style="font-size:1.2em; text-align:center; font-weight:600;  color:#FFF;">Class Wise Time Table</td></tr>
                          <tr bgcolor="#000000"><td colspan="5" style="font-size:1.0em; border-top:1px solid #EEE; text-align:center; font-weight:600;  color:#FFF;">  <?php
...
// 
	 ...
	 echo ucwords('Class Name : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.$class_id.'</span> Month : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.$monthName.'</span>
	  Week : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.$week.'</span>'); ?></td></tr>
                          ...
                          <tr bgcolor="#2092D0">
                    		<th style="color:#FFF; padding:6px 2px;  text-align:center;">Date</th>
                    		<th style="color:#FFF; padding:6px 2px;   text-align:center;">Day</th>
                    		<th style="color:#FFF; padding:6px 2px;   text-align:center;">Subject</th>  
                            <th style="color:#FFF; padding:6px 2px;   text-align:center;">Class</th> 
                            <th style="color:#FFF;  padding:6px 2px; text-align:center;">Time</th>   
						</tr>
					</thead>
                    <tbody>
                    	<?php 
					...
					//	echo $this->db->last_query(); die;
						...
						?>
                        <tr>
                            <td valign="middle" align="center"  style="font-size:13px;  border-bottom:1px solid #EEE; border-left:1px solid #EEE; padding:6px 3px; border-right:1px solid #EEE;"><?php echo $row_timetable['date'];?></td>							
							<td valign="middle" align="center" style="font-size:13px;  border-bottom:1px solid #EEE; border-left:0px solid #EEE; border-right:0px solid #EEE;padding:6px 3px;"><?php echo $row_timetable['day'];?></td>
							<td valign="middle" align="center" style="font-size:13px; line-height:18px;  border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;padding:6px 3px;"><?php echo $row_timetable['subject_name'];?></td>			
                            <td valign="middle" align="center" style="font-size:13px; line-height:18px;  border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;padding:6px 3px;"><?php echo $row_timetable['class_id'];?></td>			
                            <td valign="middle" align="center" style="font-size:13px; line-height:18px;  border-bottom:1px solid #EEE; border-left:1px solid #EEE; border-right:1px solid #EEE;padding:6px 3px;"><?php echo $row_timetable['time_start'].'  TO  '.$row_timetable['time_end'];?></td>							
                        </tr>
                        <?php endforeach;?>
