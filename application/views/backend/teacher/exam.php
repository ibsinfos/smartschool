<div class="row">
	<div class="col-md-12">
		...
		<div class="tab-content">
            ...
            <?php echo form_open(base_url() . 'index.php?teacher/exam' , array('class' => 'form-horizontal form-groups-bordered validate','id'=>'exam_result_form','target'=>'_top'));?>
...
$("#exam_result_form").submit(function( event ) {
  ...
  if(exam_name != ""){
		$.ajax({
				url: '<?php echo base_url();?>index.php?teacher/get_exam_data_table/',
				data: { exam_name:exam_name,list:'exam_schedule' },
				type: "POST",
				success: function(response)
				{
