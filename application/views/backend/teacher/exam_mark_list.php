...
<div id="main_exam_mark">
  ...
  <div id="exam_mark_sub_2" style="display:none;" >
    <form action="<?php echo base_url() . 'index.php?teacher/exam_mark/student_mark'; ?>" method="post" id="student_mark_list" class="form-horizontal validate">
...
function get_exam(class_id) {
	...
	$.ajax({
            url: '<?php echo base_url();?>index.php?teacher/get_exam/' + class_id,
