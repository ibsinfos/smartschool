<div class="panel-group joined" id="accordion-test-2">
					...
					if($_POST['class_id'] != "" && $_POST['month'] != "" && $_POST['week'] != ""){
						$array=array('teacher_id'=>$this->session->userdata('teacher_id'),'class_id'=>$_POST['class_id'],'month'=>$_POST['month'],'week'=>$_POST['week']);}
			  		else{
						$classes=array();
					}
					$this->db->distinct();
						...
						'day'=>$day);
														...
														<div class="btn-group">
															<button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
																...
																echo "<br/>";
																 echo date("d-M-Y", strtotime($row2['date']))."  ";
                                                         ...
                                                         <li>
                                                            <a href="javascript:void(0)" onclick="confirm_modal('<?php echo base_url();?>index.php?teacher/time_table/delete/<?php echo $row2['time_table_id'];?>');">
