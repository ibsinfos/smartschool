...
<script type="text/javascript">
	...
	function addId(id ,name ,message,type,typeid){
		...
		$.ajax({
			...
			url: "<?php echo base_url('/index.php?teacher/message/message_read1');?>/"+id,
	...
	$("#dropdownMenu2").change(function () {
		...
		else
		{
			...
			$.ajax({   
				...
				url: "index.php?getinfo/fromteacher", //The url where the server req would we made.
