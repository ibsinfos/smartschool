            ...
            <div class="tab-pane box active" id="list" style="width:100%;">
                ...
                <table class="table datatable table" border="0" cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:12px; letter-spacing:0.5;" id="table_export">
                	<thead>
                        ...
                        <tr bgcolor="#000000">
                        <td colspan="4" style="font-size:1.2em; text-align:center; font-weight:600;  color:#FFF;">Standard Wise Teacher Listing</td></tr>
                           <tr bgcolor="#000000"><td colspan="4" style="font-size:1.0em; border-top:1px solid #FFF; text-align:center; font-weight:600;  color:#FFF;  padding:6px 0px;"> <?php echo ucwords('Standard : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.$standard_id.'</span>'); ?></td></tr>
                    ...
                    <tbody>
						...
						$this->db->group_by('teacher_class_association.teacher_id');
						$non_tech = $this->db->get_where('teacher_class_association', array('teacher_class_association.class_id' => intval($standard_id)))->result_array();
                        ...
                        <tr>
							...
							<td align="center" style="font-size:10px; padding:6px 2px; border-bottom:1px solid #EEE; border-left:0px solid #EEE; border-right:0px solid #EEE;"><?php echo $rowtech['teacher_name'];?></td>
               ...
               <?php  if(count($non_tech) > 0){ ?>
                 <tr><td >  <?php echo form_open(base_url() . 'index.php?teacher/standard_wise_teacher_pdf' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
									<div class="form-group">
