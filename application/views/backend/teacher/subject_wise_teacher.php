            ...
            <div class="tab-pane box active" id="list" style="width:100%;">
                ...
                <table class="table datatable table" border="0" cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:12px; letter-spacing:0.5;" id="table_export">
                	<thead>
                        ...
                        <tr bgcolor="#000000"><td colspan="4" style="font-size:1.2em; text-align:center; font-weight:600;  color:#FFF;">Subject Wise Teacher Listing</td></tr>
                		 <tr bgcolor="#000000"><td colspan="4" style="font-size:1.0em; text-align:center; font-weight:600;  color:#FFF;  padding:6px 0px;"> <?php echo ucwords('Subject Name : <span style="text-align:right;color:#2092D0;font-size:1.0em;font-weight:600;">'.$subject_name.'</span>'); ?></td></tr>
                        <tr bgcolor="#2092D0">
               ...
               <?php  if(count($non_tech) > 0){ ?>
                 <tr><td >  <?php echo form_open(base_url() . 'index.php?teacher/subject_wise_teacher_pdf' , array('class' => 'form-horizontal form-groups-bordered validate'));?>
									<div class="form-group">
